...
public class MyNotification extends Application {
    ...
    private void createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            Uri sound_canh_bao=Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.sunlight_custom);
            ...
            NotificationChannel channel2 = new NotificationChannel(CHANNEL_ID_2, name_2, importance_2);
            channel2.setDescription(description_2);
